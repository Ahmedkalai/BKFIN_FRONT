...
export class DataService {
  ...
  public setInitValues(): void {
    this.creditService.Simulate(this.principalValue, this.loanValue, this.interestValue/100).subscribe(res => {
      ...
      this.interestAmt = this.getCurrencyVal(res.interest);
      this.totalAmt = this.getCurrencyVal(res.amortissement);
      this.principalAmt = this.getCurrencyVal(res.montantR);
